...
2. The Sensu installer package for IBM AIX systems is provided in **backup file
   ...
   {{< highlight shell >}}
   installp -ld sensu-1.3.0-1.powerpc.bff{{< /highlight >}}
   ...
   {{< highlight shell >}}
   installp -apXY -d sensu-1.3.0-1.powerpc.bff sensu{{< /highlight >}}

3. Install Sensu using the `installp` utility.

   {{< highlight shell >}}
   installp -aXY -d sensu-1.3.0-1.powerpc.bff sensu{{< /highlight >}}
...
[3]:  https://sensu.global.ssl.fastly.net/aix/6.1/sensu-1.3.0-1.powerpc.bff
